...
<page-query>
query($page: Int){
  entries: allProject (perPage: 10, page: $page, sortBy: "rank", order: ASC, filter: { category: { contains: ["twin"]}})@paginate{
    totalCount
    pageInfo {
      totalPages
      currentPage
...
export default {
  ...
  metaInfo() {
    return {
      title: "",
      titleTemplate: " Digital Twin | Partners",
      meta: [
        {
          key: "description",
          name: "description",
          content:
            "Meet the incredible organizations that make up the Digital Twin ecosystem.",
        },
        {
          key: "og:title",
          property: "og:title",
          content: " Digital Twin | Partners",
        },
        {
          key: "og:description",
